...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = '𝐀𝐍𝐎𝐍𝐘𝐌𝐎𝐔𝐒' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['923168066637'] // ubah aja pake nomor lu
//==========================zetsuboclient=======================//
...
global.author = '༻࿇𝐊𝐈𝐍𝐆_MIRZ4❖༺' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
